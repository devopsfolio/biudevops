...
# Список это: 
# Изменяемая структура данных, способная хранить элементы разных типов
# Список можно изменять т.к. он хранит только ссылки на обьекты
# Можно изменять размер списка и добавлять удалять и заменять его обьекты
# Упражнение 1: Работа со списками
